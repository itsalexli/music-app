...
function createNoteCountDictionary() { //need to account for a bar with 0 notes
...
function Measure({ measure, notes }) {
  ...
  const measureBarCount = Math.floor(createNoteCountDictionary()[measure]/notePerBar);
